...
//			auto_ptr<Matcher> matcher ( regexElem->rePattern->createMatcher ( line ) );		//2023/06/23//+3623R~
  			unique_ptr<Matcher> matcher ( regexElem->rePattern->createMatcher ( line ) );   //2023/06/23//+3623I~
...
//  		auto_ptr<Pattern> reDefPattern ( Pattern::compile ( "\\$[-\\w]+" ) );            //2023/06/23//+3623R~
    		unique_ptr<Pattern> reDefPattern ( Pattern::compile ( "\\$[-\\w]+" ) );          //2023/06/23//+3623I~
//			auto_ptr<Matcher> m ( reDefPattern->createMatcher ( line.substr ( noParseCmd.size() +cmdPos ) ) ); //2023/06/23//+3623R~
  			unique_ptr<Matcher> m ( reDefPattern->createMatcher ( line.substr ( noParseCmd.size() +cmdPos ) ) );   //2023/06/23//+3623I~
