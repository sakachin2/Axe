//*CID://+vc2gR~:                             update#=   46;       //~v1EjI~//~9B10R~//~vc2gR~
//**************************************************************************//~v1EjI~
//vc2g 2020/07/26 AltGr key option                                 //~vc2gI~
//**************************************************************************//~v1EjI~
package com.ahsv.gui;                                              //~vc2gI~
                                                                   //~v1EjI~
import android.widget.CompoundButton;
import android.widget.EditText;
import com.xe.Axe.Dump;                                            //~vc2gI~
import com.ahsv.AG;                                       //~vc2gI~
import com.ahsv.utils.Utils;                                       //~vc2gR~
...
{                                                                  //~v1EjI~
    ...
    {                                                              //~v1EjR~
        CommonListenerI old=AG.aCommonListenerI;                   //~9B10I~//+vc2gR~
        AG.aCommonListenerI=Plistener;                             //~v1EjR~//+vc2gR~
    ...
    {                                                              //~v1EjR~
        CommonListenerI old=AG.aCommonListenerI;                     //~v1EjR~//~9B10R~//+vc2gR~
        AG.aCommonListenerI=null;                                  //~9B10I~//+vc2gR~
    ...
    {                                                              //~v1EjR~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjR~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_UCHECKBOX,Pbtn.getId(),PisChecked ? 1 : 0,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjR~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_USPINNER,PviewID,Ppos,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjI~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_USPINNER,-1,-1,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjI~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_URADIOGROUP,Prbid,-1,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjI~
    //**************************************************************************//~v1EjI~
    //*SpinButton                                                  //~v1EjI~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_USPINBTN,PviewID,-1,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjI~
    //**************************************************************************//~v1EjI~
    //*UButtonRG                                                   //~v1EjI~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_UBUTTONRG,Pbtn.getId(),Pchecked ? 1 :0,null);//~v1EjR~//+vc2gR~
    }                                                              //~v1EjI~
    //**************************************************************************//~v1EjI~
    //*UEditText                                                   //~v1EjI~
    //**************************************************************************//~v1EjI~
    ...
    {                                                              //~v1EjI~
        ...
        if (AG.aCommonListenerI!=null)                             //~v1EjI~//+vc2gR~
	        AG.aCommonListenerI.onWidgetChanged(CL_UEDITTEXT,Pet.getId(),-1,Ptext);//~v1EjI~//+vc2gR~
    }                                                              //~v1EjI~
}                                                                  //~v1EjI~
