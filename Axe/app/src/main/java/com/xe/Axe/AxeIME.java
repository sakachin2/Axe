//*CID://+vc47R~: update#= 214;                                    //~vc47R~
//**********************************************************************//~1107I~
//vc47 2022/03/25 deprecated;Api33, packageManager.queryIntentServices//~vc47I~
//vc46 2022/03/25 deprecated;Api33, InputMethodManager.SHOW_FORCED //~vc46I~
...
//*************************                                        //~vaagI~
    ...
    {                                                              //~1826I~
    	boolean rc;                                                //~1827I~
//		rc=imm.showSoftInput(Pview,InputMethodManager.SHOW_FORCED);   //~1826I~//~1827R~//~vc46R~
		int opt=0;                                                 //~vc46I~
  		rc=imm.showSoftInput(Pview,opt);                           //~vc46I~
...
//*****************************************                        //~vc47I~
private static List<ResolveInfo> queryServices(PackageManager Ppm) //~vc47I~
{                                                                  //~vc47I~
	if (Dump.Y) Dump.println("AxeIME.queryServices");              //~vc47I~
	if (AxeG.osVersion>=33)                                        //~vc47I~
		return queryServicesFrom33(Ppm);                           //+vc47R~
    else                                                           //~vc47I~
		return queryServicesUnder33(Ppm);                          //+vc47R~
}                                                                  //~vc47I~
//*****************************************                        //~vc47I~
@SuppressWarnings("deprecation")                                   //~vc47I~
private static List<ResolveInfo> queryServicesUnder33(PackageManager Ppm)//~vc47I~
{                                                                  //~vc47I~
	if (Dump.Y) Dump.println("AxeIME.queryServicesUnder33");       //~vc47I~
    return Ppm.queryIntentServices(                                //~vc47I~
                new Intent(InputMethod.SERVICE_INTERFACE),         //~vc47I~
                PackageManager.GET_META_DATA);                     //~vc47I~
}                                                                  //~vc47I~
//*****************************************                        //~vc47I~
@TargetApi(33)                                                     //~vc47I~
private static List<ResolveInfo> queryServicesFrom33(PackageManager Ppm)//~vc47I~
{                                                                  //~vc47I~
	if (Dump.Y) Dump.println("AxeIME.queryServicesFrom33");        //~vc47I~
    PackageManager.ResolveInfoFlags flags=PackageManager.ResolveInfoFlags.of(PackageManager.GET_META_DATA);//~vc47I~
    return Ppm.queryIntentServices(                                //~vc47I~
                new Intent(InputMethod.SERVICE_INTERFACE),         //~vc47I~
                flags);                                            //~vc47I~
}                                                                  //~vc47I~
...
//      List<ResolveInfo> services = pm.queryIntentServices(       //~1831I~//~vc47R~
//              new Intent(InputMethod.SERVICE_INTERFACE),         //~1831I~//~vc47R~
//              PackageManager.GET_META_DATA);                     //~1831I~//~vc47R~
        List<ResolveInfo> services=queryServices(pm);              //~vc47I~
