...
//***************************                                      //~1826I~//~1827I~
    ...
    {                                                          //~1826I~//~1827I~
        ...
        outAttrs.imeOptions=EditorInfo.IME_ACTION_SEND             //~1830R~
                           |0x02000000 //Api11:EditorInfo.IME_FLAGS_NO_FULLSCREEN;api11//~1830I~
...
//*************************                                        //~1919I~
    public void showXeKbd(View Pview)                              //~1919I~
    {                                                              //~1919I~
...
//*************************                                        //~vaagI~
    ...
    {                                                              //~1826I~
    	...
    	if (Dump.Y) Dump.println("AxeIME showKbd rc="+rc+",view="+Pview.toString());//~1827I~
    	return rc;
    }                                                              //~1826I~
//*************************                                        //~1827I~
    public void showKbdDelayed(View Pview)                         //~1827I~
    {                                                              //~1827I~
    	if (Dump.Y) Dump.println("AxeIME showKbdDelayed view="+Pview.toString());//~1827I~
    ...
    {                                                              //~1827I~
    	if (Dump.Y) Dump.println("AxeIME onTimerEvent showSoftInput view="+Pparm.toString());//~1827R~
