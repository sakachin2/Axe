...
//*****************                                                //~1612I~
    public AxeLstShift(int PdialogId,ViewGroup PlayoutView,int Pmenuid,int Prowid)//~1817R~
    {                                                              //~1612I~
//        super(PdialogId,PlayoutView,Pmenuid,Prowid,true/*editableRow*/);//+1B02R~
		super(PdialogId,PlayoutView,Pmenuid,Prowid,true/*editableRow*/,true/*clickable*/);//+1B02I~
    }                                                              //~1612I~
//*****************                                                //~1612R~
//  public static AxeLstShift setupListView(int PdialogId,ViewGroup PlayoutView,int Pmenuid)//~1817R~
    ...
    {                                                              //~1612R~
        AxeLstShift al=new AxeLstShift(PdialogId,PlayoutView,0/*Pmenuid*/,ROWID_SHIFTKEY);//~1817R~
        return al;                                                 //~1612I~
    }                                                              //~1612R~
//*****************                                                //~1612I~
    @Override                                                      //~1612I~
