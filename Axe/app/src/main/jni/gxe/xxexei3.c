...
{                                                                  //~v55FI~
//  long dummy;                                                    //~v@@@R~
    ULONG dummy;  //compiler warning                               //~v@@@R~
...
//                    "ˆ¶æ‚Ì‰æ–Ê‚ª‚c‚‰‚’ƒŠƒXƒg‚Å‚È‚¢");           //~v68eR~
//        rc=-1;                                                   //~v68eR~
    ...
    {                                                              //~v685I~
        if (msgsw)                                                 //~v685I~
	    	uerrmsg("Ignored(select only one dir line)",           //~v685I~
                     "•¡ŽÊæ‚Í‚Ps‚¾‚¯‚ð‘I‘ðó‘Ô‚É‚µ‚Ä‚­‚¾‚³‚¢");  //~v685I~
        rc=-1;                                                     //~v686I~
        break;          //no dragdrop                              //~v686I~
    }                                                              //~v685I~
...
dprintf("synfont facename=%s,desc=%p\n",fontname,Gsynfontdesc[ii]);//~v780R~
dprintf("syn font toring=%s\n",pango_font_description_to_string((const PangoFontDescription*)(Gsynfontdesc[ii])));//~v780I~
                }                                                  //~v780I~
            }                                                      //~v780I~
        }                                                          //~v780I~
    }                                                              //~v780I~
