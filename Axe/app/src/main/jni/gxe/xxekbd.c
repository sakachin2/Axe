...
#ifndef ARM //scancode is diffrent from PC                         //~v@@@I~
...
//*************************                                        //~vXXER~
dprintf("onkeyup ch=%x,scan=%x,flag=%x\n",nChar,nScan,nFlags);     //~v76eR~
...
//	    shiftstatus(0,nChar,nFlags,&sstat);                        //~v78NR~
    ...
    {                                                              //~v69bI~
		ftime(&ctm);		//chk later lbdown                     //~v69bR~
...
//  modidx=shiftstatus(1,nChar,nFlags,&sstat);                     //~v78NR~
    ...
    dprintf("onchar str=%s,modx=%d,scan=%x,char=%x,flag=%x,iconvsw=%d\n",Pstr,modidx,nScan,nChar,nFlags,iconvsw);//~v79zR~
    if (iconvsw)                                                   //~v79zI~
    {                                                              //~v79zI~
...
#endif //ARM                                                       //~v@@@I~
//************************************                             //~v003I~
UTRACEP("onkeydown ch=%x,scan=%x,flag=%x\n",nChar,nScan,nFlags);   //~v69YR~
    Mtypematicintervalwait=0;	//stop rctk key typematic          //~v76eR~
//  modidx=shiftstatus(1,nChar,nFlags,&sstat);                     //~v78NR~
    modidx=shiftstatus(1,nChar,nScan,nFlags,&sstat);               //~v78NI~
...
//    	dosch=xxemain_keysym2doskey(nScan,nChar,modidx,Pstr,Pstrlen);//~v70mR~
    ...
    {                                                              //~v76eR~
#ifdef ARM                                                         //~v@@@I~
		return xxemain_ontimer_rctlkey(NULL);                      //~v@@@I~
#else                                                              //~v@@@I~
...
#else                                                              //~v@@@I~
//**************************************************************** //~v@@@I~
//*rctl key process                                                //~v@@@I~
//**************************************************************** //~v@@@I~
BOOL xxemain_ontimer_rctlkey(void *Pdata)                          //~v@@@I~
{                                                                  //~v@@@I~
	int sstat;                                                     //~v@@@R~
    UINT nChar;                                                    //~v@@@I~
//****************************                                     //~v@@@I~
dprintf("%s:onkey timer rctl\n",(char*)utimeedit("hh:mm:ss.mil",0));//~v@@@I~
    nChar=GDK_Control_R;                                           //~v@@@I~
	sstat=(WXEKBDMSG_RCTLKEY|WXEKBDMSG_CTLKEY);                    //~v@@@I~
	xxemain_kbdkeyin(sstat|WXEKBDMSG_KEYDOWN,0,nChar,0,0);//xe called by this key//~v@@@I~
    return TRUE;// Mpview->KillTimer(Pid);                         //~v@@@I~
}//xxemain_ontimer_rctlkey                                         //~v@@@I~
#endif //ARM                                                       //~v@@@M~
//===============================================================================//~v003I~
...
//**************************                                       //~vXXEI~
  ...
  {                                                                //~v78NI~
#ifndef ARM	//no use Linux Keycode(Spkeysymtblbykeycode is null)   //~v@@@R~
...
//  int rc=0,ii,jj,kk,ll,keysym,keycode,maxkeycode;                //~va33R~//+vaffR~
	int rc=0,ii,jj,kk,ll,keysym=0,keycode,maxkeycode;              //+vaffI~
    UCHAR *pc;                                                     //~va33I~
//***********************                                          //~va33M~
