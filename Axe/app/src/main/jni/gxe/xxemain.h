...
#define PASTE_PASTEV         0x002  //pastev                       //~v689I~
	...
	void xxemain_prtdefaultmarginrect(RECT *Pprect);               //~vXXER~
...
EXT  char   	Mformtype[32];                                     //~vXXER~
EXT  char   	Mprinter[32];                                      //~v667I~
EXT  char   	Mprinter_cupsdefault[32];                          //~va6yI~
