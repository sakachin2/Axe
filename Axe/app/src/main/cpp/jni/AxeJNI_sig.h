//vc1f 2020/06/20 ARM;chk sdcard writable                          //~0620I~
...
JNIEXPORT void JNICALL Java_com_xe_Axe_AxeJNI_jniInit
  (JNIEnv *, jclass, jstring, jstring, jstring, jstring, jint);             //~1A17R~//~0620R~
//(JNIEnv *, jclass, jstring, jstring, jstring, jint);             //~0620I~
...
JNIEXPORT void JNICALL Java_com_xe_Axe_AxeJNI_jniOptionChangedOther
  (JNIEnv *, jclass, jint, jint, jboolean, jboolean, jboolean, jint);//+0621R~
//  (JNIEnv *, jclass, jint, jint, jboolean, jboolean, jboolean);  //+0621I~
