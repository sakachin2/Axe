...
//  Mfulldrawsw=1;                                                 //~2914R~
    ...
    {                                                              //~2922I~
//  	sprintf(newtitle,"%s    CWD=%s",WXE_TITLE,newpath);        //~2922R~//~vc1iR~
    	sprintf(newtitle,"CWD=%s",newpath);                        //~vc1iI~
...
dprintf("setruler mode=%d\n",Mrulermode);                          //~v78BI~
    c2j_notifyRulerMode(Mrulermode);                               //~vbrhI~
    Mfulldrawsw=1;                                                 //~v73tI~
