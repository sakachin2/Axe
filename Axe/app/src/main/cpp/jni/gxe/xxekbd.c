//CID://+vbr8R~:            update#=6                              //+vbr8R~
//******************************************************************************//~v003I~
//vbr8:200724 0x8300 is generated by Alt+^ and Alt+= depending kbd type//+vbr8I~
...
//     {                  ,                  },//-1,      //0x3c   //~vXXEI~
//     {                  ,                  },//-1,      //0x3d   //~vXXEI~
//     { GDK_equal        ,KEY_A_EQUAL       },//0x8300,  //0x3d  = //S+'-' on japanese kbd, '^' on english kbd//~v69YI~,//~v70mR~//+vbr8R~
       { GDK_equal        ,KEY_A_EQUAL       },//0x8300,  //0x3d  = //S+'-' on japanese kbd, '^' on english kbd//~v69YI~,//+vbr8I~
//     {                  ,                  },//-1,      //0x3e   //~vXXEI~
//     {                  ,                  },//-1,      //0x3f   //~vXXEI~
...
//altchartbl index tbl                                             //~vXXEM~
    ...
    {                                                              //~vXXEM~
        ...
        UTRACEP("%s:keysym=x%x,doskey=x%x,scan=x%x\n",UTT,keysym,pact->ACTdoskey,pact->ACTscancode);//~vaffI~
...
#endif                                                             //~va3DI~
//*************************                                        //~v003I~
	UTRACEP("%s char=x%x,scan=x%x\n",UTT,nChar,nScan);             //~vaffI~
...
#endif //ARM                                                       //~v@@@I~
//************************************                             //~v003I~
UTRACEP("%s:onkeydown ch=%x,scan=%x,flag=%x\n",UTT,nChar,nScan,nFlags);   //~v69YR~//~vaffR~
    Mtypematicintervalwait=0;	//stop rctk key typematic          //~v76eR~
//  modidx=shiftstatus(1,nChar,nFlags,&sstat);                     //~v78NR~
    modidx=shiftstatus(1,nChar,nScan,nFlags,&sstat);               //~v78NI~
    ...
    {                                                              //~vXXEI~
        ...
        case  MODX_ALT:                                            //~vXXEI~
            ...
            {                                                      //~vXXEI~
	            ...
	            UTRACEP("%s:modx_alt nScan=x%x,keysym=x%x,pact=%p\n",UTT,nScan,keysym,pact);//~vaffI~
                if (pact)                                          //~vXXEI~
                {                                                  //~vaffI~
                	doskey=pact->ACTdoskey;                        //~vXXER~
		            UTRACEP("%s:modx_alt doskey=x%x\n",UTT,doskey);//~vaffI~
                }                                                  //~vaffI~
            }                                                      //~vXXEI~
        	break;                                                 //~vXXEI~
        }                                                          //~vXXEI~
...
//********************                                             //~v78NI~
    ...
    XDisplayKeycodes(Ppdisplay,&min_keycode,&max_keycode);         //~v78NI~
    UTRACEP("%s min_keycode=x%x,max=x%x\n",UTT,min_keycode,max_keycode);//~vaffI~
    ...
    {                                                              //~v78NI~
        ...
        UTRACEP("%s:keycode=%d,sym=%04x %s\n",UTT,ii,(UINT)keysym,keyname);//~v79zR~//~vaffR~
    }                                                              //~v78NI~
