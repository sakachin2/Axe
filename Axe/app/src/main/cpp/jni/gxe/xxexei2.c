//*CID://+vb91R~:                              update#=  595;      //+vb91R~
//*********************************************************************//~v440I~
//* wxe interface definition;CAP,PRT                               //~3102R~
//*********************************************************************//~v440I~
//vb91:170228 marge rh9j gxe to arm-gxe                            //+vb91I~
//				vaug:140311 (BUG)wxp cmd,display utf8 filename on dialog(mojibake if dbcs)//+vb91I~
...
//      pu8+=2;                                                    //~va6aR~
        pu8+=1;                                                    //~va6aI~
//  outlen=(ulong)pu8-(ULONG)Pout;                                 //~v@@@R~
...
{                                                                  //~2B02I~
    ...
    PUFILEC pfc;                                                   //~2B02I~
    PUFILEH pfh;                                                   //~2B02I~
    int rc,/*pfhwidth,*/lnotype=0;                                 //~vak2R~
//***********************                                          //~2B02I~
...
#ifdef UTF8UCS2                                                    //~va20I~
//     if (pfh->UFHfilenamebylc)                                   //~vaugR~//+vb91I~
//      strcpy(Pfnm,pfh->UFHfilenamebylc);                         //~vaugR~//+vb91I~
//     else                                                        //~vaugR~//+vb91I~
       if (pfh->UFHfilenamedddata)                                 //~vaugI~//+vb91I~
       {                                                           //~vaugI~//+vb91I~
           UCHAR *pu8;                                             //~vaugI~//+vb91I~
           int u8len,rc3;                                          //~vaugI~//+vb91I~
           //******************                                    //~vaugI~//+vb91I~
           rc3=xeutfcvdd2f(0,pfh->UFHfilenamedddata,pfh->UFHfilenamedddbcs,pfh->UFHfilenameddlen,&pu8,&u8len,NULL/*outdbcs*/);//~vaugI~//+vb91I~
           if (rc3<4)                                              //~vaugI~//+vb91I~
            UmemcpyZ(Pfnm,pu8,u8len);                              //~vaugI~//+vb91I~
           else                                                    //~vaugI~//+vb91I~
            strcpy(Pfnm,pfh->UFHfilename);                         //~vaugI~//+vb91I~
       }                                                           //~vaugI~//+vb91I~
       else                                                        //~vaugI~//+vb91I~
#endif                                                             //~va20I~
...
//      offsvhex=(ULONG)pdbcs-(ULONG)pdata+len;                    //~vak2R~
...
#endif                                                             //~va50I~
//UTRACED("wxe_prtgetline vhexhhex wk out",pdata,offsvhex+vhlen);  //~vak2R~
      }//vhex+hhex                                                 //~va49I~
      else                                                         //~va49I~
      {                                                            //~va49I~
...
//***********************                                          //~va87I~
#ifdef ARM                                                         //~v@@@I~
	plh=0;	//for compiler warning                                 //~v@@@I~
#endif //ARM                                                       //~v@@@I~
    if (!Sprtplh)                                                  //~va87I~
    	return 0;                                                  //~va87I~
  ...
  if (Swkvhexlineid==1||Swkvhexlineid==2)                          //~va8dI~
    ...
    UTRACEP("wxe_prtgetnext ret topplh=%d,plhlineno=%d,lineid=%d,offs=%d\n",Sprtplh->ULHlinenor,plh->ULHlinenor,Swkvhexlineid,Swkvhexoffs);//~va87I~
    *Pprc=rc;                                                      //~va87I~
	return plh;                                                    //~va87I~
...
//      *(pwdd->WDDdate+sizeof(pwdd->WDDdate))=' ';                //~v6unR~
        pcn=pwdd->WDDdate+sizeof(pwdd->WDDdate);                   //~v6unI~
        *pcn=' ';                                                  //~v6unI~
        uftimeedit(pdh->UDHtime,"HH:MM",pwdd->WDDtime);            //~2B16R~
//      *(pwdd->WDDtime+sizeof(pwdd->WDDtime))=' ';                //~v6unR~
        pcn=pwdd->WDDtime+sizeof(pwdd->WDDtime);                   //~v6unI~
        *pcn=' ';                                                  //~v6unI~
     }                                                             //~v6unI~
    }                                                              //~2B16R~
    else                    //root dir                             //~2B16R~
