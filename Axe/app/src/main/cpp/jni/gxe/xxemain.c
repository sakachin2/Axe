//*CID://+vc17R~:                             update#=  261;       //~vc17R~
//******************************************************************************//~v003I~
//vc17 2020/06/15 malloc/free requires malloc.h                    //~vc17I~
//vb4q:160810 display ligature/combine mode on "TOP OF LINE"       //~vb4qI~//~vaxaI~
//vaxa:140628 (Axe)segfault at exit by quit cmd(uerrexit but axe continue process for popup errmsg)//~vaxaI~
//vax8:140627 (for jni)var1:140116 (Bug:gxe)when trace on,ending status may not be saved//~vax8I~
...
//  Mothercharset=DEF_OTHERCHARSET;                                //~VXXER~
    ...
    Mscrwidth=XX(Mscrcmaxrow);                                     //~v003R~
    Mscrheight=YY(Mscrcmaxcol);                                    //~v003R~
//  Mpmemdc=0;                                                     //~VXXER~
//  Mpbgbitmap=0;                                                  //~VXXER~
    Mcpcopysw=0;                                                   //~v003R~
...
//  Mpwxefile=&((CWxeDoc*)Mpdoc)->Mwxefile;                        //~VXXER~
	...
	if (!Pswinigetfail)                                            //~VXXEI~
	    iniget();                                                  //~VXXER~
	UTRACEP("xxemain_init call gxedlg_init\n");                    //~v@@@I~
...
//if (wxei.WXEINIsetflag & WXEINIF_BGCOLOR)                        //~v73yR~
  ...
  if (wxei.WXEINIsetflag & WXEINIF_RULERKEY)                       //~v740I~
    ...
    dprintf("xxemain Mdblclicktimer=%d,ini=%d\n",Mdblclicktimer,wxei.WXEINIdblclicktimer);//~v@@@I~
...
//************************************                             //~v003I~
//  if (Gpframe)                                                   //~vaxaR~
//  	uactivate_menuitem(STRID_FILE_EXIT);  //uactivate_menuitem-->gtk_menu_item_activate is currently nop//~vaxaR~
//  else                                                           //~vaxaR~
//  {                                                              //~vaxaR~
