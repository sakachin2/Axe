//*CID://+vbreR~:                               update#=  668;     //+vbreR~
//*********************************************************************//~v440I~
//* wxe interface **                                               //~v69mR~
//*********************************************************************//~v440I~
//vbre:200821 (ARM)(Bug)set 2 byte "??" for f2lerr of width0 char  //+vbreI~
//vbr7:200724 when conv err,f2lerr conv to ucs to utf because wcrtomb's locale is utf8//~vbr7I~
//vbr6:200724 when conv err by icu under ICULOCAL iconv is called even Gconverter is of ICU//~vbr6I~
//vb93:170228 wxe_uerrexitstdo is duplicated with jnic2j           //~vb92I~
//vb92:170228 ndk r13 compiler warning                             //~vb92I~
//vb91:170228 marge rh9j gxe to arm-gxe                            //~vb91I~
//				vb4t:160812 consider errmsg 2nd line for combine   //~vb91I~
//				vb4q:160810 display ligature/combine mode on "TOP OF LINE"//~vb91I~
//				vaf5:120604 (WXE/XXE) msgbox for uerrexit by inifile version unmatch//~vb91I~
...
//vax9:140627 (for jni)vaf5:120604 (WXE/XXE) msgbox for uerrexit by inifile version unmatch//~vax9I~
...
#include <uicu.h>                                                  //~vbr7M~
#include <ucvext12.h>                                              //~vbr7I~
#include <ucvebc.h>                                                //~vbr7I~
#define UVIOMDEFONLY	//for uviom.h                              //~vb4rI~//~vb91I~
#include <uviom.h>                                                 //~vb4rI~//~vb91I~
                                                                   //~v440I~
#include "xe.h"                                                    //~v440R~
#include "xescr.h"                                                 //~v440I~
#include "xekbd.h"                                                 //~v440I~//~vak2M~
...
int wxe_resethdrligature(int Popt,int Pligature);                  //~vb4qI~//~vb91I~
//*************************************************************    //~2B30I~
...
{                                                                  //~v62NI~
//***********************                                          //~v62NI~
	return (char*)kbdgetname((USHORT)Pkey,Pshift);                 //~v62NI~
...
#endif                                                             //~va20I~
#ifdef TRACE                                                       //~v@@@R~
        for (rc=0;rc<Sargc;rc++)                                   //~v@@@I~
            UTRACEP("WXE_INIT req=%d,parm=%s\n",Preqtype,Sargv[rc]);//~v@@@R~
#endif                                                             //~v@@@I~
...
//                	if (uerrmsgboxokcan("Exit xe ? (File was saved)",0)!=0)	//cancelled//~v672R~
                	if (uerrmsgboxokcan("Exit xe ?","xe �I���m�F")!=0)	//cancelled//~v672I~
                    {                                              //~v66AI~
...
//      if (*Sutf8str)                                             //~va00I~//~va0TR~
 		UTRACEP("%s:Sutf8stroffs=%d,Sutf8strlen=%d\n",UTT,Sutf8stroffs,Sutf8strlen);//~vbr6I~
...
//  	if ((!sc && !ch)&& (!(pft->FTcmd)||!(*(pft->FTcmd)))) //parm exist or no key defined//~v672I~//~vb92R~
        ...
        {                                                          //~v672I~
			uerrmsgbox("No key nand cmd is defined for func %s","�@\x94\\ %s �ɃL�[�A�R�}���h�����蓖�Ă��Ă��܂���",pft->FTnamee);//~v672R~
        	rc=4;                                                  //~v672I~
        }                                                          //~v672I~
        else                                                       //~v672I~
...
//*************************************************************    //~v440I~
//*************************************************************    //~v440I~
//int  wxe_uviogetwork(UCHAR *Pbuffc,USHORT *Pbuffa,UCHAR *Plineupdate)//~v440R~//~vb4rR~
...
#endif                                                             //~va0TI~
//***********************                                          //~v440I~
UTRACEP("wxe_readkbd entry imsstrlen=%d,imnextpos=%d,Sutf8strlen=%d,Sutf8stroffs=%d\n",Simstrlen,Simnextpos,Sutf8strlen,Sutf8stroffs);//~va3DR~//~vbr6R~
...
//***********************                                          //~v440I~
//  umsgbox(Ppmsg);                                                //~vax9R~
    umsgbox(Ppmsg,MB_OK);                                          //~vax9I~
  	exit(24);                                                      //~2901R~
}//wxe_uerrexitstdo                                                //~v440I~
#endif  //!ARM                                                     //~vb93R~
#ifndef XXE                                                        //~vaf5I~//~vb91I~
//*************************************************************    //~v440I~
//*************************************************************    //~v440I~
char *wxeenqmsg(char *Ppmsg,char *Ppprevmsg)                       //~2A07R~
{                                                                  //~v440I~
...
//    case  3:                                                     //~vaa3R~
//    case  4:                                                     //~vaa3R~
	case PANL00PARM:	//   3 	//0:PARM                           //~vaa3R~
	case PANL00COLOR:	//   4 	//0.0 COLOR                        //~vaa3R~
    	cmdid='0';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  5:                                                     //~vaa3R~
	case PANL00SCCMD:	//   5 	//0.1 SC-CMD                       //~vaa3R~
    	cmdid='A';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  6:                                                     //~vaa3R~
	case PANL00F_K:  	//   6 	//0.2 FUNC-KEY                     //~vaa3R~
    	cmdid='B';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  7:                                                     //~vaa3R~
	case PANL00K_F:  	//   7 	//0.3 KEY_FUNC                     //~vaa3R~
    	cmdid='C';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  8:                                                     //~vaa3R~
	case PANL00BROWSE:	//  8 	//1 BROWSE                         //~vaa3R~
    	cmdid='1';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  9:                                                     //~vaa3R~
	case PANL00EDIT:	//    9 	//2 EDIT                       //~vaa3R~
    	cmdid='2';                                                 //~3102I~
        break;                                                     //~3102I~
	case PANL00COMP:	//   11 	//3.12 COMPARE                 //~vaa3R~
    	cmdid='F';                                                 //~vaa3R~
        break;                                                     //~vaa3R~
	case PANL00SRCH:	//   12 	//3.14 SEARCH                  //~vaa3R~
    	cmdid='G';                                                 //~vaa3R~
        break;                                                     //~vaa3R~
//    case  10:                                                    //~vaa3R~
	case PANL00CMD:		//    13 	//6 CMD                        //~vaa3R~
    	cmdid='6';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  11:                                                    //~vaa3R~
	case PANL00EXIT:	//   15 	//X EXIT                       //~vaa3R~
    	cmdid='X';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  12:                                                    //~vaa3R~
	case PANL00RET: 	//   16 	//R RETURN                     //~vaa3R~
    	cmdid='R';                                                 //~3102I~
        break;                                                     //~3102I~
//    case  13:                                                    //~vaa3R~
	case PANL00QUIT:	//   17 	//Q QUIT                       //~vaa3R~
    	cmdid='Q';                                                 //~3102I~
        break;                                                     //~3102I~
    }                                                              //~3102I~
    if (!cmdid)                                                    //~3102I~
...
//	WUCS ucs;                                                      //~va3DI~//~va72R~
  	UWUCS ucs;                                                     //~va72I~
    int rc=0,dbcssz,/*opt,*/chklen,nlsopt;                         //~vak2R~
...
//**************                                                   //~va3DI~
    ...
    {                                                              //~va3DI~
//  	opt=UTFCVO_ERRREP|(XEUTF_ERRREPCH_F2LFILE<<8);             //~vak2R~
//  	rc=ucvext_iconvucs2local1(0,(ULONG)Gconverters,(WUCS)ucs,mbstr,&dbcssz);//~va3DI~//~vbr6R~
//  	rc=ucvext_icuucs2local1(0,(ULONG)Gconverters,(WUCS)ucs,mbstr,&dbcssz);//~vbr6I~//~vbr7R~
        opt=EBC2ASC_LOCALCV;	//local converter                  //~vbr7I~
    	rc=ucvext_icuucs2local1(opt,(ULPTR)(((ULONG**)Gconverters)[ICULCPL_CONVERTER]),(WUCS)ucs,mbstr,&dbcssz);//~vbr7R~
		UTRACEP("%s:icuucs2local rc=%d,ucs=0x%4x\n",UTT,rc,ucs);//~va3DI~//~vbr6R~
		UTRACED("mbstr",mbstr,dbcssz);                             //~vbr6I~
        if (!rc)                                                   //~va3DI~
        {                                                          //~va3DI~
    ...
    if (dbcssz==0)    //width0                                     //+vbreI~
    {                                                              //+vbreI~
		Pkeyinfo->bNlsShift=KBDNLS_F2L_ERR|KBDNLS_F2L_SBCS;        //+vbreI~
        rc=1;                                                      //+vbreI~
        Pkeyinfo->mbstr[0]=XEUTF_ERRREPCH_F2LFILE;                 //+vbreI~
        Pkeyinfo->mbstr[1]=0;                                      //+vbreI~
    }                                                              //+vbreI~
    else                                                           //+vbreI~
    {                                                              //~va3DI~
        ...
        {                                                          //~va3bI~
            ...
            {                                                      //~va3bI~
                ...
                {                                                  //~va3tI~
                    ...
                    if (offs>=0)                                   //~va3tI~
                    {                                              //~va3tI~
                    	rc2=xeutf_getvhexpos(0,Ppcw,plh,offs,&pos,0/*out dbcsid*/);//~va3tI~
...
//            }                                                    //~va6qR~
    ...
    if (Ppinfo)                                                    //~va3bI~
    	*Ppinfo=rcinfo;                                            //~va3bI~
UTRACEP("csrposchk rc=%d,row=%d,col=%d,info=%x,rrow=%d,rcol=%d\n",rc,Prow,Pcol,rcinfo,rrow,rcol);//~va6qR~
dprintf("csrposchk rc=%d,row=%d,col=%d,info=%x,rrow=%d,rcol=%d\n",rc,Prow,Pcol,rcinfo,rrow,rcol);//~va6qI~
    return rc;                                                     //~va3bI~
...
//************************                                         //~va3dI~
    ...
    {                                                              //~va3dI~
      ...
      if (pcw)  //not at before xe INIT call                       //~vb4qI~//~vb91I~
      {                                                            //~vb4qI~//~vb91I~
		wxe_resethdrligature(0,Mligature);                         //~vb4qR~//~vb91I~
...
//===============================================================================//~vb4rI~//~vb91I~
//chk row is ligature line                                         //~vb4rI~//~vb91I~
//===============================================================================//~vb4rI~//~vb91I~
int wxe_getlineopt(int Popt,int Prow,int Pcol)                     //~vb4rI~//~vb91I~
{                                                                  //~vb4rI~//~vb91I~
	PUCLIENTWE pcw;                                                //~vb4rI~//~vb91I~
//  int lineopt,vsplit2nd,errmsglineopt=0;                         //~vb74R~//~vb91I~
    int lineopt,vsplit2nd;                                         //~vb74I~//~vb91I~
//************************                                         //~vb4rI~//~vb91I~
	pcw=scrgetcw(2);    //2nd pcw                                  //~vb4rI~//~vb91I~
    vsplit2nd=((pcw && pcw->UCWorgx && Pcol>=pcw->UCWorgx) ? UVIOO_VSPLIT2ND :0);//~vb4rI~//~vb91I~
//  lineopt=uvio_getbufflineopt(0,Prow,vsplit2nd);                 //~vb4tR~//~vb91I~
    lineopt=uvio_getbufflineopt(0,Prow,vsplit2nd,Pcol);            //~vb4tI~//~vb91I~
//    if (lineopt & UVIOO_ERRMSGMASK)                              //~vb4tR~//~vb91I~
//    {                                                            //~vb4tR~//~vb91I~
//        errmsglineopt=lineopt>>16;                               //~vb4tR~//~vb91I~
//        if (vsplit2nd)                                           //~vb4tR~//~vb91I~
//        {                                                        //~vb4tR~//~vb91I~
//            if (Pcol==pcw->UCWorgx)                              //~vb4tR~//~vb91I~
//                lineopt=errmsglineopt;                           //~vb4tR~//~vb91I~
//        }                                                        //~vb4tR~//~vb91I~
//        if (!Pcol)                                               //~vb4tR~//~vb91I~
//            lineopt=errmsglineopt;                               //~vb4tR~//~vb91I~
//    }                                                            //~vb4tR~//~vb91I~
    UTRACEP("%s:Prow=%d,Pcol=%d,rc:lineopt=%04x,vsplit2nd=%04x\n",UTT,Prow,Pcol,lineopt,vsplit2nd);//~vb74R~//~vb91I~
    return lineopt;                                                //~vb4rI~//~vb91I~
}//wxe_getlineopt                                                  //~vb4rI~//~vb91I~
//*************************************************************    //~vb4qI~//~vb91I~
int wxe_resethdrligature(int Popt,int Pligature)                   //~vb4qR~//~vb91I~
{                                                                  //~vb4qI~//~vb91I~
    PUCLIENTWE pcw;                                                //~vb4qI~//~vb91I~
//***********************                                          //~vb4qI~//~vb91I~
    UTRACEP("%s:Pligature=%d\n",UTT,Pligature);                    //~vb4qI~//~vb91I~
	pcw=scrgetcw(0);	//active client                            //~vb4qI~//~vb91I~
	optresethdrligcomb(0,pcw);                                     //~vb4qI~//~vb91I~
    scrdisp();          //update screen                            //~vb4qI~//~vb91I~
    return 0;                                                      //~vb4qI~//~vb91I~
}//wxe_resethdrligature                                            //~vb4qI~//~vb91I~
