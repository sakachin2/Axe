//*CID://+vc06R~:                             update#=  349;
//*********************************************************************//~v440I~
//* wxe interface definition                                       //~v440I~
//*********************************************************************//~v440I~
//vc06:2020/06/10 Axe:GWXES_UPDATEMENU not defined. correct anyway for pass compile
//vc05:2020/06/10 Axe:WXEM_SETRGN2 not defined. correct anyway for pass compile
//vc04:2020/06/10 GWXES_SELECTALL not defined. correct anyway
...
//vb4r:160811 (XXE) v4f for XXE((ULIB:v6Ei)specify ligature on/off,combine on/of line by line(used for edit/filename  panel))//~va8aI~
...
//*wxe-->xe *****                                                  //~v440R~
  ...
  #define GWXES_SELECTALL    0x1000 //parm to func_lmark_file      //~vbd2I~//~vc04I~
  #define GWXES_UPDATEMENU   0x2000 //update File menu enabl/disable//~vbdnI~//+vc06I~
                                                                   //~va20M~
...
#define DNDCOPY_REP 0x01                                           //~v686I~
    ...
    #define WXEM_SETRGN2   0x04        //set Mcpcopysw=2 for SEL ALL cmd//~vbd8I~//~vc05I~
                                                                   //~v69ZI~
...
//  int  wxe_uviogetwork(UCHAR *Pbuffc,USHORT *Pbuffa,UCHAR *Plineupdate);//~v440R~//~vb4rR~
    int  wxe_uviogetwork(UCHAR *Pbuffc,USHORT *Pbuffa,UCHAR *Plineupdate,int *Plineopt);//~vb4rR~
...
//**                                                               //~va3dI~
	...
	#define XXECCPI_VHEXCSRMASK   0xff00	//vhexcsr pos          //~va3tI~
...
#define WXE_OPTLIGATURE (xxe_optligature(XXEIOLO_ISON,0/*pvalue*/))//~vb4rI~//~vb91I~
#define WXE_LIGATUREMODE(opt)  (  \
                                   (   (opt & UVIOO_FORCELIGATURE)                  \
                                    || ((opt & UVIOO_LIGATURE) && WXE_OPTLIGATURE)   \
                                                                   ...
                                                                   //~va3dI~
	int  wxe_uerrexitmsgbox(char *Ppmsg);	                       //~vaf5I~//~vb91M~
#endif	// .c                                                      //~v440I~
#ifdef __cplusplus                                                 //~v440I~
}                                                                  //~v440I~
#endif                                                             //~v440I~
